                            ...
                            @foreach ($produk->photos as $photo)
                                <div class="swiper-slide zoom-image-hover">
                                    <img class="img-responsive m-auto"
                                        src="{{ asset('storage/product/images/' . $photo->foto) }}" alt="">
                                </div>
                            @endforeach
                        </div>
                    </div>
                ...
                <div class="col-lg-7 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="200">
                    <div class="product-details-content quickview-content">
                        ...
                        <div class="pricing-meta">
                            <ul>
                                <li class="old-price not-cut">Rp {{ number_format($produk->price, 2) }}</li>
                            </ul>
                        </div>
                        ...
                        <div class="pro-details-policy">
                            <ul>
                                ...
                                <li><img src="assets/images/icons/policy-2.png" alt="" /><span>Delivery Policy
                                        (Edit
